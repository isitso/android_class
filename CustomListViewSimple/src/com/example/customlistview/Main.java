...
public class Main extends ListActivity {
	String[] list = { "ipsum", "laurum", "etgort", "youturt", "semilale",
			"tortouse", "germone", "alchemisery", "nupperror", "surrondstores", "ylen",
			"tropison", "alz", "zera", "Arnold Schwarzenegger", "Barak Obama", "Tupac"};
